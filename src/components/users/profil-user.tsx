...
export default function ProfilUser(props: {
    ...
    // Fonction permettant d'effectuer la requête de la recherche d'un ami dans la base de données
    ...
    // Fonction permettant de faire une demande d'ami
    ...
    return (
        <div className="profil-user-container">
            ...
            {/* LISTE D'AMIS */}
            <UserFriends token={token} newFriend={newFriend} />
